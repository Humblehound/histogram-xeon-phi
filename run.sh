...
echo "Compiling..."
sshpass -p 'student' ssh student12@apl12.eti.pg.gda.pl 'cd 143297 && source /opt/intel/composer_xe_2013_sp1.3.174/bin/compilervars.sh intel64 && icpc -O2 -vec-report -openmp BmpImage.cpp main.cpp'
echo "Running..."
